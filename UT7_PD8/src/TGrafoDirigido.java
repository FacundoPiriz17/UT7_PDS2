...
public class TGrafoDirigido implements IGrafoDirigido {
    ...
    public void clasificarArcos(Comparable verticeO,TipoListaArcos arcosArbol, TipoListaArcos arcosRetroceso, TipoListaArcos arcosAvance, TipoListaArcos arcosCruzados) {
